"""The public ``add_comment`` MCP tool."""
...
from server.instructions import ADD_COMMENT_DESCRIPTION
...
def register(mcp: MCPServer, default_provider: str = "jira", provider: JiraProvider | None = None) -> None:
    ...
    def add_comment(
        ...
        try:
            raw = resolved_provider.add_comment(normalized_key, body=body)
        ...
        return ensure_json_result(raw, issue_key=normalized_key, added=False)
