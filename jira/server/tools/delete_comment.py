"""The public ``delete_comment`` MCP tool."""
...
from server.instructions import DELETE_COMMENT_DESCRIPTION
...
def register(mcp: MCPServer, default_provider: str = "jira", provider: JiraProvider | None = None) -> None:
    ...
    def delete_comment(
        ...
        try:
            raw = resolved_provider.delete_comment(normalized_key, normalized_id)
        ...
        return ensure_json_result(raw, issue_key=normalized_key, comment_id=normalized_id, deleted=False)
